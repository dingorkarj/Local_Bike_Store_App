...
namespace Purchases
{
    public partial class Deliveries_List : Deliveries_Template
    {

        
     //  IdentityObject _ident;
         public Deliveries_List(IdentityObject identObject)
        {
            InitializeComponent();
            label_SubName.Text = "Deliveries";
        //    _ident =  identObject;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dtable != null)
            {
                ...
                dataGridView1.Columns[7].HeaderText = "Purchse Order Date";
                dataGridView1.Columns[6].HeaderText = "Delivery Date";
                dataGridView1.Columns[8].HeaderText = "Total Cost";
            }
            dataGridView1.Visible = true;
        }
        private void ResetCommand()
        {
            //string part1 = "select DocNum,DocType,ExtRef,IntRef,status,TextValue1,TextValue2,comments from Deliveries";
            string part1 = "select * from " + PODConstants.DELIVERY_TABLE_NAME + " Where DocType = 13";
            //if (radioBtn_Invoices.Checked) part1 = "select DocNum,DocType,ExtRef,IntRef,status,TextValue1,TextValue2,comments from PurchaseOrders ";
            string part2 = "";
            string part3 = "";
            if (comboBox1.SelectedIndex > 0)
                part2 = " and ExtRef = " + textBox_Supplier.Text;
            if (comboBox2.SelectedIndex > 0)
            {
                if (comboBox1.SelectedIndex > -1)
                    part3 = " and status = " + textBox_Status.Text;
                else part3 = " and status =  " + textBox_Status.Text;
            }
        ...
        {
            Purchases.DisplayDelivery podf = new Purchases.DisplayDelivery(base.ident,dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString());
            podf.Show();
            this.Close();
