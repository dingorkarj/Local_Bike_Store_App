...
namespace Utilities.Documents
{
    public partial class ListObjects : Document_Template
    {
       List<string> _documentIDs;
        ...
        //{
        //    string part1 = "select * from Gendocs ";
        //    string part2 = "";
        //    string part3 = "";
        //    if (comboBox_DocType.SelectedIndex > 0)
        //        part2 = " where docType = " + textBox_DocType.Text ;
        //    if (comboBox_TableName.SelectedIndex > 0)
        //    {
        //        if (comboBox_DocType.SelectedIndex > 0)
        //            part3 = " and Status =  " + comboBox_TableName.SelectedItem.ToString();
        //            else    part3 = " where status =  " + comboBox_TableName.SelectedItem.ToString();
        //    }
       ...
       // }
        ...
        {    // (1) Download a table of queries
            ...
            List<string> queryList = Utilities.DataBaseUtility.GetList("select * from BasicQueries");
        ...
        protected virtual void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            DisplaySelectedObject pds = new DisplaySelectedObject(base.ident, textBox_TableName.Text, docTypeStr, docNumStr);
                           //  dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString(), dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString());
            pds.Show();
